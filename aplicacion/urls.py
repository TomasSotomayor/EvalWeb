...
urlpatterns = [
    ...
    path('RegistrarseFormulario/' , views.RegistrarseFormulario, name='RegistrarseFormulario'),
    ...
    path('desuscribirse/', views.desuscribirse, name='desuscribirse'),
    path('cerrarsesion/', views.cerrarsesion, name='cerrarsesion'),
    path('recuperardatosusuario/', views.recuperardatosusuario, name='recuperardatosusuario'),
